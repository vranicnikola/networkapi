...
import phd.remoteaircondition.AndroidNetworkApi.NetwrokMessagesID;
...
public class NetworkMessage {
    ...
    public NetworkMessage(){
        ...
        id = NetwrokMessagesID.NM_NO_ID.ordinal();
        size = 0;
        data = null;
    }
    
    public NetworkMessage(NetwrokMessagesID id, int size, byte [] data){
        this.id = id.ordinal();
    ...
    public NetwrokMessagesID getIdEnum(){
        return NetwrokMessagesID.values()[id];
    }
    
    public String getIdDes(){
        return AndroidNetworkApi.NETWORK_MESSAGE_ID_DES[id];
    }
